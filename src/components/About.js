  ...
  return (
    <div name="about" className='w-full h-full bg-gradient-to-b from-gray-800 to-black text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full' >
            ...
            Jeg startede på multimediedesigner uddannelsen i 2021 og går nu på 3. semester. Denne uddannelse tiltalte mig særligt på grund af at man får lov til at være kreativ og eksperimenterende.
...
Har en stor passion for at lære nye teknologier som kan gavne mit workflow, heriblandt frameworks, librabries og nye versioner af programmeringssprog. 
            ...
            Ved udviklingsfasen er jeg altid klar med en vision om hvordan jeg skal nå i mål med mit projekt, en velstruktureret plan og deadlines er et must.
